	...
	<div class="col-md-12 ">
		<div class="card">
			...
			<div class="card-body card-body-custom">
				<form id="formContent1" enctype="multipart/form-data" action="{{ route('action-update-user') }}" method="POST" autocomplete="new-password">
					@csrf
					<div class="card-body card-body-custom">
						<div class="row mb-2">
							<div class="col-xl-12">
                <div class="mb-3 row">
                  ...
                  <div class="col-7">
                    ...
                    <input name="name" id="inp-name" type="text" class="form-control" value="{{ $user->name }}" required>
                  </div>
                </div>
                <div class="mb-3 row">
                  <label class="col-3 col-form-label custom-label" style="text-align: right;">Username</label>
                  <div class="col-7">
                    <input name="username" id="inp-username" type="text" class="form-control" value="{{ $user->username }}" required>
                  </div>
                </div>
                <div class="mb-3 row">
                  <label class="col-3 col-form-label custom-label" style="text-align: right;">Email</label>
                  <div class="col-7">
                    <input name="email" id="inp-email" type="text" class="form-control" value="{{ $user->email }}">
                  </div>
                </div>
								<div class="mb-3 row">
									...
									<div id="select-customer-name" class="col-7">
										<select name="level" id="sel-level" class="form-control">
											...
											<option value="ADMS" {{ $user->level == 'ADMS' ? 'selected' : '' }}>Administrator</option>
											<option value="ADM" {{ $user->level == 'ADM' ? 'selected' : '' }}>Admin Data</option>
											<option value="MKT" {{ $user->level == 'MKT' ? 'selected' : '' }}>Marketing</option>
										</select>
									</div>
								</div>
								<div class="mb-3 row">
									...
									<div class="col-7">
										<input name="password" id="inp-password" type="password" class="form-control" value="" autocomplete="new-password">
									</div>
								</div>
                <div class="mb-3 row">
                  <label class="col-3 col-form-label custom-label" style="text-align: right;">Retype Password</label>
                  <div class="col-7">
                    <input name="confirm_password" id="inp-confirm-password" type="password" class="form-control" value="" autocomplete="new-password">
                  </div>
                </div>
