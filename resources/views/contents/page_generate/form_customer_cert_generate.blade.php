							...
							<div class="col-xl-12">
								<div class="mb-3 row">
									...
									<div id="select-customer-area" class="col-7">
										<input name="note" id="user-fullname" type="text" class="form-control" value="{{ old('note') }}">
										<input name="id" type="hidden" value="{{ $customer->cst_id }}">
									</div>
								</div>
								<div class="mb-3 row">
									<label class="col-3 col-form-label custom-label" style="text-align: right;">File Data</label>
									<div id="select-customer-area" class="col-7">
										<input type="file" class="form-control mb-1" name="file_upload">
										@if ($errors->any())
										<div style="color: red;">
											<ul>
