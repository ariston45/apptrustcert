        ...
        <div class="card-body card-body-custom">
          <div class="row">
            <div class="col-6">
              ...
              <br> <p class="mb-2"><i>{{ $data_record->rec_name }}</i></p>
              @if($user->level == 'ADMS' || $user->level == 'ADM')
              <button class="badge bg-orange-lt" data-bs-toggle="modal" data-bs-target="#modal-update-generator"><i
                  class="ri-edit-2-line"></i> Update Data</button>
              @if ($data_record->rec_sync_date === null)
              <button class="badge bg-red-lt" data-bs-toggle="modal" data-bs-target="#modal-delete-generator"><i
                  class="ri-delete-bin-2-fill"></i> Delete Data</button>
              @endif
              @endif
            </div>
            <div class="col-6 " style="text-align: end; vertical-align: middle;">
              @if ($data_record->rec_sync_date == null)
      ...
      <div class="card">
        <div class="card-header card-header-custom card-header-light">
          ...
          <div class="card-actions" style="padding-right: 10px;">
            ...
            <button type="submit" form="formGenTemplateCertGold" class="btn btn-sm btn-indigo btn-square "
              style="vertical-align: middle;">
              <div style="font-weight: 700;">
                <i class="ri-draft-line icon" style="font-size: 14px; vertical-align: middle;"></i> Digital Certificate Gold
              </div>
            </button>
            <button type="submit" form="formGenTemplateCertSilver" class="btn btn-sm btn-indigo btn-square "
              style="vertical-align: middle;">
              <div style="font-weight: 700;">
                <i class="ri-draft-line icon" style="font-size: 14px; vertical-align: middle;"></i> Digital Certificate Silver
              </div>
            ...
            <table class="table custom-datatables" style="width: 100%;">
              <thead>
                <tr>
                  ...
                  <th style="width: 10%;">No. Certificate</th>
                  ...
                  <tr>
                    ...
                    <td>
                      @if($user->level == 'ADMS' || $user->level == 'ADM')
                        ...
                        <a href="{{ url('generate/download_cert/' . $list['par_id']) }}" style="text-decoration: none;">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered mt-1" role="document">
      <div class="modal-content">
            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-xl-12">
                <div class="mb-2 mt-0 row" style="margin-right: 0px;">
                  <label class="col-3 col-form-label pt-1 pb-1">Name</label>
                  <div class="col" style="padding: 0px;">
                    <input type="text" name="name" class="form-control p-1" value="{{ $data_record->rec_name }}"
                ...
                <div class="mb-2 mt-0 row" style="margin-right: 0px;">
                  ...
                  <div class="col" style="padding: 0px;">
                    <input type="text" name="notes" class="form-control p-1" value="{{ $data_record->rec_note }}"
                ...
                <div class="mb-2 mt-0 row" style="margin-right: 0px;">
                  ...
                  <div class="col" style="padding: 0px;">
                    <select name="cert_type" id="cert-type" class="form-control p-1" required="">
                      ...
                      <option value="{{ $list->cert_id }}" @if ($data_record->rec_cert_type == $list->cert_id) selected
                        @endif>[{{ $list->cert_type }}] {{ $list->cert_title }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                <div class="mb-2 mt-0 row" style="margin-right: 0px;">
                  ...
                  <div class="col" style="padding: 0px;">
                    <select name="cert_template" id="cert-template" class="form-control p-1" required="">
                      ...
                      @php $index = 2; @endphp
                      <option value="{{ $list->ctm_id }}" @if ($data_record->rec_template == $list->ctm_id) selected
                        @endif >[{{ $index }}] {{ $list->ctm_name }}</option>
                      @else
                      @php $index = 1; @endphp
                      <option value="{{ $list->ctm_id }}" @if ($data_record->rec_template == $list->ctm_id) selected
                        @endif>[{{ $index }}] {{ $list->ctm_name }}</option>
        ...
        <div class="modal-footer">
          ...
          <div class="col-auto">
            <button type="button" id="ResetButtonFormFolUp" class="btn btn-sm me-auto"
              style="margin: 0px; width: 50px;"><i class="ri-refresh-line"></i></button>
            <button type="submit" class="btn btn-sm btn-ghost-primary active" form="formContent2"
              style="margin:0px; padding-left: 20px;padding-right: 16px;">Update</button>
          </div>
        </div>
      </div>
    </div>
